...
if __name__ == "__main__":
    ...
    model = TCANet(emb_size=300, input_output_size=1, num_channels=[16, 16, 16, 16], _, num_sub_blocks=2, temp_attn=600, nheads, en_res,
                 conv, key_size, kernel_size=3, dropout=0.5, wdrop=0.0, emb_dropout=0.1, tied_weights=False,
                 dataset_name=None, visual=True)
    print(model)
